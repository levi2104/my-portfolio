  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="fixed w-[20%] text-center top-10 -right-11 bg-neonBlue text-[#000000] px-4 py-1 font-semibold shadow-lg transform rotate-45 translate-x-8 -translate-y-4 z-50"
      >
        Resume.pdf
      </a>
