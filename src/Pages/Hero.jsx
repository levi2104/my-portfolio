...
const Hero = () => {
  return (
    <section
  className="relative min-h-screen bg-darkBg text-whiteText overflow-auto md:overflow-hidden flex flex-col md:flex-row items-center justify-center px-6 md:px-12"
  ...
  >
    ...
    >
      <Link to="contact" smooth={true} duration={800}>
        <span className="px-5 py-3 w-fit text-neonPurple bg-darkBg border-[3px] border-neonPurple font-semibold rounded-lg shadow-lg hover:scale-105 transition-all duration-300 block cursor-pointer lg:w-[26%] lg:mx-0 mx-auto">
          Hire Me
        </span>
      </Link>
    </motion.div>
